...
contract NFTPoolBurnAndMint is CCIPReceiver, OwnerIsCreator {
  ...
  constructor(
    address _router,
    address _link,address wnftAddress
  ...
  function _ccipReceive(
    ...
    internal
    override
    // (any2EvmMessage.sourceChainSelector, abi.decode(any2EvmMessage.sender, (address))) // Make sure
    // source chain and sender are allowlisted

  {
    //tokenId,nwOwner
    RequestData memory req = abi.decode(any2EvmMessage.data, (RequestData));
